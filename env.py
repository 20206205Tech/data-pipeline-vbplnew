...
GOOGLE_DRIVE_FOLDER_ID_DATA_PIPELINE_VBPLNEW = env.str(
    "GOOGLE_DRIVE_FOLDER_ID_DATA_PIPELINE_VBPLNEW"
)
GOOGLE_DRIVE_FOLDER_ID = GOOGLE_DRIVE_FOLDER_ID_DATA_PIPELINE_VBPLNEW
